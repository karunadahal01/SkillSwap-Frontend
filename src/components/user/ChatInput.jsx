...
export function ChatInput({
  ...
  // ✅ IMPROVED: Only use keyboardHeight in native mode
  // In native mode with 'native' resize, the viewport already shrinks
  // So we don't need to add extra bottom padding
  const bottomPosition = isNative && keyboardHeight > 0 ? 0 : 0;
  ...
  return (
    <Box
      ...
      sx={{
        ...
        zIndex: 1000,
        bgcolor: theme.palette.background.paper,
        // ✅ Remove transition in native mode for smoother keyboard behavior
        transition: "none",
        paddingBottom: isNative ? "env(safe-area-inset-bottom, 0)" : 0,
      }}
    >
