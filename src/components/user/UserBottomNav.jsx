...
export default function UserBottomNav({ bottomNavHeightRef }) {
  ...
  const totalUnreadCount = chatUsers.reduce((total, chatUser) => {
    return total + (chatUser.unreadCount || 0);
  }, 0);
    ...
    >
      ...
      >
        {navItems.map(({ text, icon: Icon }, index) => {
          ...
          const isMessagesTab = text === "Messages";
          const showBadge = isMessagesTab && totalUnreadCount > 0;
