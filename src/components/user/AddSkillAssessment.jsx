  ...
  //   const [availableSkills, setAvailableSkills] = useState([]); // skills dropdown
  //   const [selectedSkill, setSelectedSkill] = useState(null); // chosen skill
  ...
  //   useEffect(() => {
  //     if (open) {
  //       fetchSkills(); // load skills on open
  //     }
  //   }, [open]);

  //   const fetchSkills = async () => {
  //     try {
  //       const skills = await getAllSkills(); // api call
  //       const filtered = skills.filter(s => !excludeSkillIds.includes(s.skillId)); // remove already added
  //       setAvailableSkills(filtered); // set state
  //     } catch (err) {
  //       console.error("Failed to fetch skills:", err);
  //       toast.error("Failed to load available skills"); // show toast
  //     }
  //   };

  //   const handleSkillSelect = (skill) => {
  //     setSelectedSkill(skill); // set chosen skill
  //     setAnswers({}); // reset answers
  //     setError(""); // reset error
      
  //     // Check if this skill has assessment questions
  //     if (QUESTIONS[skill.skillName]) {
  //       setStep(2); // go to assessment
  //     } else {
  ...
  //     return questions.every((_, i) => answers[i]); // check all answered
  //   };
  ...
  //       if (answers[i] === q.answer) correct++; // count correct answers
  //     });

  //     const percent = (correct / questions.length) * 100; // calculate score percentage
  ...
  //       handleClose();
  //       if (onSkillAdded) onSkillAdded(); // notify parent
  //     } catch (err) {
