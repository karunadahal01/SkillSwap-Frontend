...
const initialSwaps = [
  {
    ...
    mySkill: "Painting",
    theirSkill: "Guitar",
    scheduledAt: new Date(2025, 9, 10, 18, 0).toISOString(),
    status: "Requested",
  },
  {
    id: 2,
    ...
    scheduledAt: new Date(2025, 9, 9, 16, 0).toISOString(),
    status: "Accepted",
  },
  {
    id: 3,
    ...
    mySkill: "Cooking",
    theirSkill: "Yoga",
    scheduledAt: new Date(2025, 9, 7, 10, 30).toISOString(),
    status: "Completed",
  },
  {
    id: 4,
    ...
    mySkill: "Java",
    theirSkill: "Photography",
    scheduledAt: new Date(2025, 9, 11, 14, 0).toISOString(),
    status: "Pending",
  },
  {
    id: 5,
    ...
    mySkill: "Python",
    theirSkill: "Guitar",
    scheduledAt: new Date(2025, 9, 12, 9, 0).toISOString(),
    status: "Requested",
  },
  {
    id: 6,
    ...
    mySkill: "CSS",
    theirSkill: "Cooking",
    scheduledAt: new Date(2025, 9, 13, 11, 0).toISOString(),
    status: "Cancelled",
  },
];
...
export default function UserSwaps() {
  ...
  const [statusFilter, setStatusFilter] = useState("All"); // All or status string
  ...
  // Action handlers (simulate API updates)
  ...
  // Small badge text describing who requested
  ...
  return (
    <Box sx={{ p: 3 }}>
      ...
      {filtered.length === 0 ? (
        ...
        <>
          {/* Note: alignItems: 'stretch' + Grid item display:flex + Paper flex:1 make all cards equal width/height */}
          <Grid container spacing={3} sx={{ alignItems: "stretch" }}>
            {visible.map((s) => (
              <Grid item xs={12} md={6} key={s.id} display="flex">
                <Paper
                  elevation={3}
                  sx={{
                    p: 2,
                    ...
                    minHeight: 10,       // consistent minimum height
                  }}
                >
                  {/* Left: content (flex:1 so it grows) */}
                  ...
                  {/* Right: actions (keeps natural size) */}
          ...
          {selectedSwap && (
            <>
              ...
              <Typography variant="body2" color="text.secondary">
                Scheduled: {format(new Date(selectedSwap.scheduledAt), "PPP • p")}
              </Typography>

              <Typography variant="body2" sx={{ mt: 2 }}>
                Notes: Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nulla facilisi.karuna
              </Typography>
