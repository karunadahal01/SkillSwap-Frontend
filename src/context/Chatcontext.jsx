...
//       // Check if this is replacing a pending message (optimistic update)
//       const pendingIndex = existing.findIndex(msg => msg._pending && msg.content === content);
...
//         if (response.success) {
//           console.log('✅ Message with files sent via REST API');
//           // The message will come back via WebSocket, so we just need to replace the pending one
//         }
//       } else {
